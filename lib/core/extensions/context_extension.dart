...
extension MediaQueryExtension on BuildContext {
  ...
  double get scaleFactorHeight => safeHeight / 820 < 1 ? safeHeight / 820 + ((1 - safeHeight / 820) * (1 - safeHeight / 820)) : safeHeight / 820;

  double get scaleFactorWidth => safeWidth / 392 < 1 ? safeWidth / 392 + ((1 - safeWidth / 392) * (1 - safeWidth / 392)) : safeWidth / 392;
